...
int corte = 400;
int corteSecundario = 300;
int corteSecundario7 = 140;
int cortePretoMeio = 200;
int corteVerde = 270; // tava 330
int corteVerdeDireita = 270;

int tempoEntreParedes = 5000;
int tempoDesceGarra = 1200;
int tempoNoventaGraus = 1200;
int tempoNoventaGrausEsquerda = 900;
int tempoFrenteVerdeNoventa = 600;
