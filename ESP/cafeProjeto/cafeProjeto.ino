...
#include <UniversalTelegramBot.h>
 ...
 // WiFi
#define SSID "2G NetVirtua 306b"
#define SENHA "pos26041982@" 

 // Declaração das variáveis: 
#define BOT_TOKEN "654707387:AAEEJuAMyWy7o33PMFw6kDLCub-OXEvG3uw" // Seu token gerado pelo bot vai aqui
...
UniversalTelegramBot bot(BOT_TOKEN, client); // Instanciando nosso bot
 ...
 const String SOLICITAR = "solicitar café";
...
void quandoInicia(String idChat, String nomeUsuario){
  ...
  mensagem += "Está querendo café? Posso te ajudar. Basta me solicitar.\n\n";
...
String listaDeComandos(){
  ...
  mensagem += "<b>\"" + STATS + "\"</b>: Para visualizar o estado do carrinho;\n";
  mensagem += "<b>\"" + SOLICITAR + "\"</b>: Para solicitar seu café.";
...
void quandoStatus(String idChat){
  String mensagem;
  if(disponivel == true){
    mensagem+= "O café está <b>disponível</b>, caso deseje, digite: solicitar café";
  } else {
    mensagem+= "O café está <b>indisponível</b>, caso deseje ser notificado quando estiver pronto digite /notificar";
  }
  bot.sendMessage(idChat, mensagem, "HTML");
}
